...
1. **Playwright (web gestão)** — ajusta dia/mês da DN do colaborador `Aniversariante` para o dia/mês do teste.
...
2. O spec loga com `PHJESUS` / `poly1000` se cair na tela de login.
