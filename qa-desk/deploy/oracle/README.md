...
O Caddyfile isola os SSE (`…/kb-curation/stream` e `/api/bugs/gestor-replies/stream`) **sem gzip** e com `flush_interval -1`. Sem isso a stream pode bufferizar e a UI só atualiza no F5.
